...
import com.tinymonster.stepcount.MainActivity;
...
import step.accelerometer.StepCount;
import step.accelerometer.StepValuePassListener;
import step.bean.StepData;
import step.utils.DbUtils;

public class StepService extends Service implements SensorEventListener{
    private String TAG = "MyStepService";
    /**
     * 默认为30秒进行一次存储
     */
    ...
    public void onCreate() {
        super.onCreate();
        Log.d(TAG, "onCreate()");
        initNotification();//启动前台服务,初始化通知栏
        initTodayData();//
    ...
    private void initNotification() {
        ...
        mBuilder.setContentTitle(getResources().getString(R.string.app_name))
                .setContentText("今日您已走" + CURRENT_STEP + " 步！")
    ...
    private void initTodayData() {
        ...
        DbUtils.createDb(this, "MonsterStepCount");
